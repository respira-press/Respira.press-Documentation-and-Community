...
Generates the [readiness report](/toolkits/divi-5-migration-readiness-report): the Divi 4 / Divi 5 / mixed split, high-risk pages, migration candidates, and unrecognised shortcodes. The report is cached per user for 24 hours, and the screen has a button to regenerate it on demand.
</Step>
