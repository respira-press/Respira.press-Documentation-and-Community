...
description: "Reference for current Respira MCP tools. Find the right tool for pages, posts, builders, snapshots, menus, SEO analysis, and more."
---
...
### Element Operations (7 tools) <span style={{color: '#10b981'}}>NEW in 5.2</span>
...
### Page Building (3 tools) <span style={{color: '#10b981'}}>NEW in 5.2</span>
...
### Stock Images (2 tools) <span style={{color: '#10b981'}}>NEW in 5.2</span>
...
### Widget Shortcuts (27 tools) <span style={{color: '#10b981'}}>NEW in 5.2</span>
