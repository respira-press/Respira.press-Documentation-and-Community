...
<Update label="2026-06-02" description="Respira for WordPress v7.1.0 — Roots" tags={["feature", "builders", "responsive", "bricks", "playbooks", "admin"]}>

### What's New in v7.1.0 "Roots"

The biggest release since launch. Roots widens the builder coverage, adds responsive inference, gives Bricks a real design-system toolset, introduces repeatable agent workflows, and rebuilds the admin.
