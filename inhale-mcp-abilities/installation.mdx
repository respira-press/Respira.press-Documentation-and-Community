...
Inhale follows the [WPackagist](https://wpackagist.org) conventions; if your `composer.json` already includes WPackagist, no additional repository configuration is needed.
