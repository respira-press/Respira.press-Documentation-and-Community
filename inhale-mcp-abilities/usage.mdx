...
Abilities marked **Managed** are managed by another plugin, typically the MCP Adapter's discovery ability, and cannot be toggled from Inhale: [MCP Abilities](/inhale-mcp-abilities/overview).
