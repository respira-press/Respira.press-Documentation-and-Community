...
Respira also keeps its **standalone desktop MCP server** for Cursor, Claude Code, Windsurf, and other local [MCP clients](/inhale-mcp-abilities/connecting-mcp-clients).
...
4. **Browser surfaces**
   Includes built-in Browser AI/WebMCP plus the curated [Elementor](https://www.respira.press/elementor-mcp) Angie bridge.
