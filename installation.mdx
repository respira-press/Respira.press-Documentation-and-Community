---
title: Install Respira for WordPress
description: Step-by-step setup: install the Respira plugin, configure MCP from the dashboard for Claude Cowork, Cursor, Codex, and Claude Code, and connect your AI assistant safely.
---
