...
The person whose yes matters often has no WordPress login: a client, a colleague, an outside reviewer. Since plugin 8.7.5, every staged duplicate returns a [share preview](/share-preview-links) link alongside the write, and the response message repeats it so assistants quote the right URL.
