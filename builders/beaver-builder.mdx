...
This page is the technical reference. For what Respira does on Beaver Builder, how it connects to Claude and ChatGPT, and how every edit lands on a copy first, start with the [Beaver Builder MCP server](https://www.respira.press/beaver-mcp) page.
