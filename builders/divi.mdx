...
This page is the technical reference. For what Respira does on Divi, how it connects to Claude and ChatGPT, and how every edit lands on a copy first, start with the [Divi MCP server](https://www.respira.press/divi-mcp) page.
