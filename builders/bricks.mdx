...
This page is the technical reference. For what Respira does on Bricks, how it connects to Claude and ChatGPT, and how every edit lands on a copy first, start with the [Bricks MCP server](https://www.respira.press/bricks-mcp) page.
...
- [`respira_find_element`](/tools/overview) — Find elements by content, type, or class
- [`respira_update_element`](/tools/overview) — Update a single element
...
- [`respira_bricks_design_system`](/builders/bricks) — Full design system snapshot
