...
This page is the technical reference. For what Respira does on WPBakery, how it connects to Claude and ChatGPT, and how every edit lands on a copy first, start with the [WPBakery MCP server](https://www.respira.press/wpbakery-mcp) page.
