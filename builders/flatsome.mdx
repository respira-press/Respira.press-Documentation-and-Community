...
This page is the technical reference. For what Respira does on Flatsome, how it connects to Claude and ChatGPT, and how every edit lands on a copy first, start with the [Flatsome MCP server](https://www.respira.press/flatsome-mcp) page.
