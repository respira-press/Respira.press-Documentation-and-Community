...
1. Open [your respira.press dashboard](https://respira.press/dashboard/mcp).
2. Click **Download Cowork config** on the Cowork card.
3. Save the file to `~/.respira/config.json`.
4. Open a new Cowork chat. the plugin picks up the file on startup.

Or run `/respira:connect-site` inside Cowork and the skill walks you through it in plain language.
