...
- **46 skills** that auto-activate when the conversation matches: safety, page-builder detection, multi-site context, mobile experience report, technical debt audit, WooCommerce health check, SEO + [AEO amplifier](https://www.respira.press/skills/seo-aeo-amplifier), internal link builder, image optimizer, 16 builder-to-builder migration recipes, and more.
